...
export interface IRegionUpdateProps {
  getEntity: ICrudGetAction<IRegion>;
  updateEntity: ICrudPutAction<IRegion>;
  createEntity: ICrudPutAction<IRegion>;
  region: IRegion;
  reset: Function;
  loading: boolean;
  updating: boolean;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhi-region-heading">Create or edit a Region</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
